...
public class Cat extends Filie{
    int x;
    int y;
    int a;
    int b;
    int c;
    Cat(){}
    Cat(int xx,int yy,int aa,int bb,int cc){
    ...
    protected void picture(){
        System.out.println("Hình ảnh Con Mèo!!!");

    }
    @Overdive
    protected void makeNoise(){
        System.out.println("Noise: Phát ra file tổng hợp các tiếng kêu của Con Mèo");
    }
