...
public class Lion extends Filie {
    int x;
    int y;
    int a;
    int b;
    int c;
    Lion(){}
    Lion(int xx,int yy,int aa,int bb,int cc){
    ...
    @Overdive
    protected void food(){
        System.out.println("Food : Ăn thịt ");
    }
    @Overdive
    protected void picture(){
        System.out.println("Hình ảnh Con Sư Tử!!!");

    }
    @Overdive
    protected void makeNoise(){
        System.out.println("Noise: Phát ra file tổng hợp các tiếng kêu của Con Sư Tử");
    }
